...
![image-20250213172715474](https://cdn.jsdelivr.net/gh/houyaogit/Pictures@master/PicGo/image-20250213172715474.png)
...
![img](https://cdn.jsdelivr.net/gh/houyaogit/Pictures@master/PicGo/format,png-20250213172458720.png)

#### 7.为什么用NoSQL

今天我们可以通过第三方平台( 如: Google，Facebook等) 可以很容易的访问和抓取数据。用户的个人信息，社交网络，地理位置，用户生成的数据和用户操作日志已经成倍的增加。我们如果要对这些用户数据进行挖掘，那SQL数据库已经不适合这些应用了，NoSQL数据库的发展也却能很好的处理这些大的数据。

![img](https://cdn.jsdelivr.net/gh/houyaogit/Pictures@master/PicGo/format,png-20250213172458945.png)
...
![img](https://cdn.jsdelivr.net/gh/houyaogit/Pictures@master/PicGo/format,png-20250213172459822.png)
...
- 热点缓存
  ![img](https://cdn.jsdelivr.net/gh/houyaogit/Pictures@master/PicGo/format,png-20250213172500762.png)
...
- 图形
  ![img](https://cdn.jsdelivr.net/gh/houyaogit/Pictures@master/PicGo/format,png-20250213172501205.png)
...
![img](https://cdn.jsdelivr.net/gh/houyaogit/Pictures@master/PicGo/format,png-20250213172501628.png)
...
![img](https://imgconvert.csdnimg.cn/aHR0cHM6Ly9naXRlZS5jb20vamFsbGVua3dvbmcvTGVhcm5SZWRpcy9yYXcvbWFzdGVyL2ltYWdlLzIxLnBuZw?x-oss-process=image/format,png)
...
![img](https://cdn.jsdelivr.net/gh/houyaogit/Pictures@master/PicGo/format,png-20250213172502361.png)
...
![img](https://cdn.jsdelivr.net/gh/houyaogit/Pictures@master/PicGo/format,png-20250213172502898.png)

类似Java编译异常

##### 冤头债主

![img](https://cdn.jsdelivr.net/gh/houyaogit/Pictures@master/PicGo/format,png-20250213172503095.png)
...
![img](https://cdn.jsdelivr.net/gh/houyaogit/Pictures@master/PicGo/format,png-20250213172503532.png)
...
![img](https://cdn.jsdelivr.net/gh/houyaogit/Pictures@master/PicGo/format,png-20250213172504159.png)

当有新消息通过 PUBLISH 命令发送给频道 channel1 时， 这个消息就会被发送给订阅它的三个客户端：

![img](https://cdn.jsdelivr.net/gh/houyaogit/Pictures@master/PicGo/format,png-20250213172504377.png)
...
- 主机日志 ![img](https://cdn.jsdelivr.net/gh/houyaogit/Pictures@master/PicGo/format,png-20250213172505089.png)
- 备机日志 ![img](https://cdn.jsdelivr.net/gh/houyaogit/Pictures@master/PicGo/format,png-20250213172505333.png)
- `info replication` ![img](https://cdn.jsdelivr.net/gh/houyaogit/Pictures@master/PicGo/format,png-20250213172505590.png)
...
2. 原有的master挂了
3. 投票新选
4. 重新主从继续开工，info replication查查看
...
[TestPool.java](https://blog.csdn.net/u011863024/article/details/src/main/java/com/lun/shang/TestPool.java)
