...
> 简化Spring应用开发的一个框架（可以避免以前必须执行的所有样板代码和配置。 ）；
>
> 整个Spring技术栈的一个大整合；
>
> J2EE开发的一站式解决方案；
...
## 3、配置文件值注入（@ConfigurationProperties @Value）
...
![SLF4J](https://gitee.com/houyao123/my-resource/raw/master/img/SLF4J-5349091.png)
...
![SLF4J-legacy](https://gitee.com/houyao123/my-resource/raw/master/img/SLF4J-legacy.png)
...
https://docs.spring.io/spring-data/jpa/docs/1.0.0.RELEASE/reference/html/#project
